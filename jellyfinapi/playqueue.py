...
class PlayQueue(JellyfinObject):
    """Control a PlayQueue.
    ...
    Attributes:
        ...
        items (list): List of :class:`~jellyfinapi.base.Playable` or :class:`~jellyfinapi.playlist.Playlist`
        ...
        selectedItem (:class:`~jellyfinapi.base.Playable`): Media object for the currently selected item.
        _server (:class:`~jellyfinapi.server.JellyfinServer`): JellyfinServer associated with the PlayQueue.
    ...
    def get(
        ...
        """Retrieve an existing :class:`~jellyfinapi.playqueue.PlayQueue` by identifier.

        Parameters:
            server (:class:`~jellyfinapi.server.JellyfinServer`): Server you are connected to.
    ...
    def create(
        ...
        """Create and return a new :class:`~jellyfinapi.playqueue.PlayQueue`.

        Parameters:
            server (:class:`~jellyfinapi.server.JellyfinServer`): Server you are connected to.
            items (:class:`~jellyfinapi.base.JellyfinPartialObject`):
                A media item or a list of media items.
            startItem (:class:`~jellyfinapi.base.Playable`, optional):
    ...
    def fromStationKey(cls, server, key):
        ...
        Parameters:
            server (:class:`~jellyfinapi.server.JellyfinServer`): Server you are connected to.
            key (str): A station key as provided by :func:`~jellyfinapi.library.LibrarySection.hubs()`
                or :func:`~jellyfinapi.audio.Artist.station()`
    ...
    def addItem(self, item, playNext=False, refresh=True):
        ...
        Parameters:
            item (:class:`~jellyfinapi.base.Playable` or :class:`~jellyfinapi.playlist.Playlist`): Single media item or Playlist.
            playNext (bool, optional): If True, add this item to the front of the "Up Next" section.
                ...
                See https://support.jellyfin.tv/articles/202188298-play-queues/ for more details.
    ...
    def moveItem(self, item, after=None, refresh=True):
        ...
        Parameters:
            item (:class:`~jellyfinapi.base.Playable`): An existing item in the PlayQueue to move.
            afterItemID (:class:`~jellyfinapi.base.Playable`, optional): A different item in the PlayQueue.
    ...
    def refresh(self):
        """Refresh the PlayQueue from the Jellyfin server."""
