...
class Audio(JellyfinPartialObject, PlayedUnplayedMixin):
    """ Base class for all audio objects including :class:`~jellyfinapi.audio.Artist`,
        :class:`~jellyfinapi.audio.Album`, and :class:`~jellyfinapi.audio.Track`.
        ...
        Attributes:
            ...
            guid (str): Jellyfin GUID for the artist, album, or track (jellyfin://artist/5d07bcb0403c64029053ac4c).
            index (int): Jellyfin index number (often the track number).
            ...
            musicAnalysisVersion (int): The Jellyfin music analysis version for the item.
    ...
    def sonicallySimilar(
        ...
        **kwargs,
        ...
        Parameters:
            ...
            **kwargs: Additional options passed into :func:`~jellyfinapi.base.JellyfinObject.fetchItems`.

        Returns:
            List[:class:`~jellyfinapi.audio.Audio`]: list of sonically similar audio items.
        """
...
class Artist(
    ...
    """ Represents a single Artist.
        ...
        Attributes:
            ...
            countries (List<:class:`~jellyfinapi.media.Country`>): List country objects.
    ...
    def album(self, title):
        """ Returns the :class:`~jellyfinapi.audio.Album` that matches the specified title.
    ...
    def albums(self, **kwargs):
        """ Returns a list of :class:`~jellyfinapi.audio.Album` objects by the artist. """
    ...
    def track(self, title=None, album=None, track=None):
        """ Returns the :class:`~jellyfinapi.audio.Track` that matches the specified title.
            ...
            Raises:
                :exc:`~jellyfinapi.exceptions.BadRequest`: If title or album and track parameters are missing.
        """
    ...
    def tracks(self, **kwargs):
        """ Returns a list of :class:`~jellyfinapi.audio.Track` objects by the artist. """
        key = f'{self.key}/allLeaves'
        return self.fetchItems(key, Track, **kwargs)

    def get(self, title=None, album=None, track=None):
        """ Alias of :func:`~jellyfinapi.audio.Artist.track`. """
        return self.track(title, album, track)

    def download(self, savepath=None, keep_original_name=False, subfolders=False, **kwargs):
        """ Download all tracks from the artist. See :func:`~jellyfinapi.base.Playable.download` for details.
    ...
    def station(self):
        """ Returns a :class:`~jellyfinapi.playlist.Playlist` artist radio station or `None`. """
...
class Album(
    ...
    """ Represents a single Album.
        ...
        Attributes:
            ...
            TYPE (str): 'album'
            collections (List<:class:`~jellyfinapi.media.Collection`>): List of collection objects.
            formats (List<:class:`~jellyfinapi.media.Format`>): List of format objects.
            genres (List<:class:`~jellyfinapi.media.Genre`>): List of genre objects.
            guids (List<:class:`~jellyfinapi.media.Guid`>): List of guid objects.
            key (str): API URL (/library/metadata/<ratingkey>).
            labels (List<:class:`~jellyfinapi.media.Label`>): List of label objects.
            leafCount (int): Number of items in the album view.
            loudnessAnalysisVersion (int): The Jellyfin loudness analysis version level.
            originallyAvailableAt (datetime): Datetime the album was released.
            parentGuid (str): Jellyfin GUID for the album artist (jellyfin://artist/5d07bcb0403c64029053ac4c).
            ...
            styles (List<:class:`~jellyfinapi.media.Style`>): List of style objects.
            subformats (List<:class:`~jellyfinapi.media.Subformat`>): List of subformat objects.
    ...
    def track(self, title=None, track=None):
        """ Returns the :class:`~jellyfinapi.audio.Track` that matches the specified title.
            ...
            Raises:
                :exc:`~jellyfinapi.exceptions.BadRequest`: If title or track parameter is missing.
        """
    ...
    def tracks(self, **kwargs):
        """ Returns a list of :class:`~jellyfinapi.audio.Track` objects in the album. """
        key = f'{self.key}/children'
        return self.fetchItems(key, Track, **kwargs)

    def get(self, title=None, track=None):
        """ Alias of :func:`~jellyfinapi.audio.Album.track`. """
        return self.track(title, track)

    def artist(self):
        """ Return the album's :class:`~jellyfinapi.audio.Artist`. """
        return self.fetchItem(self.parentKey)

    def download(self, savepath=None, keep_original_name=False, **kwargs):
        """ Download all tracks from the album. See :func:`~jellyfinapi.base.Playable.download` for details.
...
class Track(
    ...
    """ Represents a single Track.
        ...
        Attributes:
            ...
            grandparentGuid (str): Jellyfin GUID for the album artist (jellyfin://artist/5d07bcb0403c64029053ac4c).
            ...
            parentGuid (str): Jellyfin GUID for the album (jellyfin://album/5d07cd8e403c640290f180f9).
    ...
    def album(self):
        """ Return the track's :class:`~jellyfinapi.audio.Album`. """
        return self.fetchItem(self.parentKey)

    def artist(self):
        """ Return the track's :class:`~jellyfinapi.audio.Artist`. """
...
@utils.registerJellyfinObject
class TrackSession(JellyfinSession, Track):
...
@utils.registerJellyfinObject
class TrackHistory(JellyfinHistory, Track):
