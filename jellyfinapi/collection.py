...
from jellyfinapi.base import JellyfinPartialObject
from jellyfinapi.exceptions import BadRequest, NotFound, Unsupported
from jellyfinapi.library import LibrarySection, ManagedHub
...
class Collection(
    ...
    """ Represents a single Collection.
        ...
        Attributes:
            ...
            collectionPublished (bool): True if the collection is published to the Jellyfin homepage.
            ...
            guid (str): Jellyfin GUID for the collection (collection://XXXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXX).
            index (int): Jellyfin index number for the collection.
    ...
    def section(self):
        """ Returns the :class:`~jellyfinapi.library.LibrarySection` this collection belongs to.
        """
    ...
    def item(self, title):
        """ Returns the item in the collection that matches the specified title.
            ...
            Raises:
                :class:`jellyfinapi.exceptions.NotFound`: When the item is not found in the collection.
        """
        for item in self.items():
    ...
    def visibility(self):
        """ Returns the :class:`~jellyfinapi.library.ManagedHub` for this collection. """
    ...
    def get(self, title):
        """ Alias to :func:`~jellyfinapi.library.Collection.item`. """
        ...
        """ Add items to the collection.
            ...
            Parameters:
                items (List): List of :class:`~jellyfinapi.audio.Audio`, :class:`~jellyfinapi.video.Video`,
                    or :class:`~jellyfinapi.photo.Photo` objects to be added to the collection.

            Raises:
                :class:`jellyfinapi.exceptions.BadRequest`: When trying to add items to a smart collection.
        """
        if self.smart:
    ...
    def removeItems(self, items):
        """ Remove items from the collection.
            ...
            Parameters:
                items (List): List of :class:`~jellyfinapi.audio.Audio`, :class:`~jellyfinapi.video.Video`,
                    or :class:`~jellyfinapi.photo.Photo` objects to be removed from the collection.

            Raises:
                :class:`jellyfinapi.exceptions.BadRequest`: When trying to remove items from a smart collection.
        """
        if self.smart:
    ...
    def moveItem(self, item, after=None):
        """ Move an item to a new position in the collection.
            ...
            Parameters:
                item (obj): :class:`~jellyfinapi.audio.Audio`, :class:`~jellyfinapi.video.Video`,
                    or :class:`~jellyfinapi.photo.Photo` object to be moved in the collection.
                after (obj): :class:`~jellyfinapi.audio.Audio`, :class:`~jellyfinapi.video.Video`,
                    or :class:`~jellyfinapi.photo.Photo` object to move the item after in the collection.

            Raises:
                :class:`jellyfinapi.exceptions.BadRequest`: When trying to move items in a smart collection.
        """
        if self.smart:
    ...
    def updateFilters(self, libtype=None, limit=None, sort=None, filters=None, **kwargs):
        """ Update the filters for a smart collection.
            ...
            Raises:
                :class:`jellyfinapi.exceptions.BadRequest`: When trying update filters for a regular collection.
        """
        if not self.smart:
    ...
    def create(cls, server, title, section, items=None, smart=False, limit=None,
        ...
        """ Create a collection.
            ...
            Parameters:
                server (:class:`~jellyfinapi.server.JellyfinServer`): Server to create the collection on.
        ...
        """ Add the collection as sync item for the specified device.
            ...
            Parameters:
                videoQuality (int): idx of quality of the video, one of VIDEO_QUALITY_* values defined in
                                    :mod:`~jellyfinapi.sync` module. Used only when collection contains video.
                photoResolution (str): maximum allowed resolution for synchronized photos, see PHOTO_QUALITY_* values in
                                       the module :mod:`~jellyfinapi.sync`. Used only when collection contains photos.
                audioBitrate (int): maximum bitrate for synchronized music, better use one of MUSIC_BITRATE_* values
                                    from the module :mod:`~jellyfinapi.sync`. Used only when collection contains audio.
            ...
            Raises:
                :exc:`~jellyfinapi.exceptions.BadRequest`: When collection is not allowed to sync.
                :exc:`~jellyfinapi.exceptions.Unsupported`: When collection content is unsupported.
