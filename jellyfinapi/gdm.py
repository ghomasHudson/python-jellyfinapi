"""
Support for discovery using GDM (Good Day Mate), multicast protocol by Jellyfin.

# Licensed Apache 2.0
# From https://github.com/home-assistant/netdisco/netdisco/gdm.py

Inspired by:
  hippojay's jellyfinGDM: https://github.com/hippojay/script.jellyfinbmc.helper/resources/lib/jellyfingdm.py
  iBaa's JellyfinConnect: https://github.com/iBaa/JellyfinConnect/JellyfinAPI.py
"""
import socket
import struct
    ...
    def update(self, scan_for_clients):
        ...
        Examples of the dict list assigned to self.entries by this function:
            ...
            Server:
                ...
                [{'data': {
                     'Content-Type': 'jellyfin/media-server',
                     'Host': '53f4b5b6023d41182fe88a99b0e714ba.jellyfin.direct',
                     'Name': 'myfirstjellyfinserver',
                     'Port': '32400',
            ...
            Clients:
                ...
                [{'data': {'Content-Type': 'jellyfin/media-player',
                     'Device-Class': 'stb',
                     'Name': 'jellyfinamp',
                     'Port': '36000',
                     'Product': 'Jellyfinamp',
        ...
        if scan_for_clients:
            # setup socket for broadcast to Jellyfin clients
            sock.setsockopt(socket.SOL_SOCKET, socket.SO_REUSEADDR, 1)
            sock.setsockopt(socket.SOL_SOCKET, socket.SO_BROADCAST, 1)
            gdm_ip = '255.255.255.255'
            gdm_port = 32412
        else:
            # setup socket for multicast to Jellyfin server(s)
            gdm_ip = '239.0.0.250'
            gdm_port = 32414
