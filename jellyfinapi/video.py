...
from jellyfinapi import media, utils
from jellyfinapi.base import Playable, JellyfinPartialObject, JellyfinHistory, JellyfinSession
...
class Video(JellyfinPartialObject, PlayedUnplayedMixin):
    """ Base class for all video objects including :class:`~jellyfinapi.video.Movie`,
        :class:`~jellyfinapi.video.Show`, :class:`~jellyfinapi.video.Season`,
        :class:`~jellyfinapi.video.Episode`, and :class:`~jellyfinapi.video.Clip`.
        ...
        Attributes:
            ...
            guid (str): Jellyfin GUID for the movie, show, season, episode, or clip (jellyfin://movie/5d776b59ad5437001f79c6f8).
    ...
    def augmentation(self):
        """ Returns a list of :class:`~jellyfinapi.library.Hub` objects.
            ...
            Jellyfin Pass and linked Tidal account are required.
        """
        account = self._server.myJellyfinAccount()
        tidalOptOut = next(
            (service.value for service in account.onlineMediaSources()
                if service.key == 'tv.jellyfin.provider.music'),
            None
        )
        if account.subscriptionStatus != 'Active' or tidalOptOut == 'opt_out':
            raise BadRequest('Requires Jellyfin Pass and Tidal Music enabled.')
    ...
    def searchSubtitles(self, language='en', hearingImpaired=0, forced=0):
        """ Search for on-demand subtitles for the video.
            See https://support.jellyfin.tv/articles/subtitle-search/.
            ...
            Returns:
                List<:class:`~jellyfinapi.media.SubtitleStream`>: List of SubtitleStream objects.
        """
        params = {
            'language': language,
    ...
    def downloadSubtitles(self, subtitleStream):
        """ Download on-demand subtitles for the video.
            ...
            Parameters:
                subtitleStream (:class:`~jellyfinapi.media.SubtitleStream`):
                    Subtitle object returned from :func:`~jellyfinapi.video.Video.searchSubtitles`.
        """
    ...
    def removeSubtitles(self, subtitleStream=None, streamID=None, streamTitle=None):
        """ Remove an upload or downloaded subtitle from the video.
            ...
            Parameters:
                subtitleStream (:class:`~jellyfinapi.media.SubtitleStream`, optional): Subtitle object to remove.
    ...
    def optimize(self, title='', target='', deviceProfile='', videoQuality=None,
        ...
        """ Create an optimized version of the video.
            ...
            Parameters:
                ...
                videoQuality (int, optional): Index of the quality profile, one of ``VIDEO_QUALITY_*``
                    values defined in the :mod:`~jellyfinapi.sync` module. Only used if ``target`` is custom.
                locationID (int or :class:`~jellyfinapi.library.Location`, optional): Default -1 for
                    "In folder with original items", otherwise a :class:`~jellyfinapi.library.Location` object or ID.
                    See examples below.
            ...
            Raises:
                :exc:`~jellyfinapi.exceptions.BadRequest`: Unknown quality profile target
                    or missing deviceProfile and videoQuality.
                :exc:`~jellyfinapi.exceptions.BadRequest`: Unknown location ID.
            ...
            Example:
                ...
                .. code-block:: python
                    ...
                    from jellyfinapi.sync import VIDEO_QUALITY_10_MBPS_1080p
                    ...
                    from jellyfinapi.sync import VIDEO_QUALITY_ORIGINAL
                    locations = jellyfin.library.section("Movies")._locations()
        ...
        """
        from jellyfinapi.library import Location
...
class Movie(
    ...
    """ Represents a single Movie.
        ...
        Attributes:
            ...
            chapters (List<:class:`~jellyfinapi.media.Chapter`>): List of Chapter objects.
            ...
            markers (List<:class:`~jellyfinapi.media.Marker`>): List of marker objects.
            ...
            producers (List<:class:`~jellyfinapi.media.Producer`>): List of producers objects.
            ...
            slug (str): The clean watch.jellyfin.tv URL identifier for the movie.
            similar (List<:class:`~jellyfinapi.media.Similar`>): List of Similar objects.
            ...
            writers (List<:class:`~jellyfinapi.media.Writer`>): List of writers objects.
    ...
    def reviews(self):
        """ Returns a list of :class:`~jellyfinapi.media.Review` objects. """
        data = self._server.query(self._details_key)
        return self.findItems(data, media.Review, rtag='Video')

    def editions(self):
        """ Returns a list of :class:`~jellyfinapi.video.Movie` objects
...
class Show(
    ...
    """ Represents a single Show (including all seasons and episodes).
        ...
        Attributes:
            ...
            genres (List<:class:`~jellyfinapi.media.Genre`>): List of genre objects.
            guids (List<:class:`~jellyfinapi.media.Guid`>): List of guid objects.
            index (int): Jellyfin index number for the show.
            key (str): API URL (/library/metadata/<ratingkey>).
            labels (List<:class:`~jellyfinapi.media.Label`>): List of label objects.
            languageOverride (str): Setting that indicates if a language is used to override metadata
                (eg. en-CA, None = Library default).
            ...
            similar (List<:class:`~jellyfinapi.media.Similar`>): List of Similar objects.
            slug (str): The clean watch.jellyfin.tv URL identifier for the show.
    ...
    def onDeck(self):
        """ Returns show's On Deck :class:`~jellyfinapi.video.Video` object or `None`.
    ...
    def season(self, title=None, season=None):
        """ Returns the season with the specified title or number.
            ...
            Raises:
                :exc:`~jellyfinapi.exceptions.BadRequest`: If title or season parameter is missing.
        """
    ...
    def seasons(self, **kwargs):
        """ Returns a list of :class:`~jellyfinapi.video.Season` objects in the show. """
        key = f'{self.key}/children?excludeAllLeaves=1'
    ...
    def episode(self, title=None, season=None, episode=None):
        """ Find a episode using a title or season and episode.
            ...
            Raises:
                :exc:`~jellyfinapi.exceptions.BadRequest`: If title or season and episode parameters are missing.
        """
    ...
    def episodes(self, **kwargs):
        """ Returns a list of :class:`~jellyfinapi.video.Episode` objects in the show. """
        key = f'{self.key}/allLeaves'
        return self.fetchItems(key, Episode, **kwargs)

    def get(self, title=None, season=None, episode=None):
        """ Alias to :func:`~jellyfinapi.video.Show.episode`. """
        return self.episode(title, season, episode)

    def watched(self):
        """ Returns list of watched :class:`~jellyfinapi.video.Episode` objects. """
        return self.episodes(viewCount__gt=0)

    def unwatched(self):
        """ Returns list of unwatched :class:`~jellyfinapi.video.Episode` objects. """
        return self.episodes(viewCount=0)

    def download(self, savepath=None, keep_original_name=False, subfolders=False, **kwargs):
        """ Download all episodes from the show. See :func:`~jellyfinapi.base.Playable.download` for details.
            ...
            Parameters:
                ...
                **kwargs: Additional options passed into :func:`~jellyfinapi.base.JellyfinObject.getStreamURL`.
        """
        filepaths = []
...
class Season(
    ...
    """ Represents a single Season.
        ...
        Attributes:
            ...
            parentGuid (str): Jellyfin GUID for the show (jellyfin://show/5d9c086fe9d5a1001f4d9fe6).
            parentIndex (int): Jellyfin index number for the show.
            parentKey (str): API URL of the show (/library/metadata/<parentRatingKey>).
            parentRatingKey (int): Unique key identifying the show.
            parentSlug (str): The clean watch.jellyfin.tv URL identifier for the show.
    ...
    def onDeck(self):
        """ Returns season's On Deck :class:`~jellyfinapi.video.Video` object or `None`.
    ...
    def episode(self, title=None, episode=None):
        """ Returns the episode with the given title or number.
            ...
            Raises:
                :exc:`~jellyfinapi.exceptions.BadRequest`: If title or episode parameter is missing.
        """
    ...
    def episodes(self, **kwargs):
        """ Returns a list of :class:`~jellyfinapi.video.Episode` objects in the season. """
        key = f'{self.key}/children'
        return self.fetchItems(key, Episode, **kwargs)

    def get(self, title=None, episode=None):
        """ Alias to :func:`~jellyfinapi.video.Season.episode`. """
        return self.episode(title, episode)

    def show(self):
        """ Return the season's :class:`~jellyfinapi.video.Show`. """
    ...
    def download(self, savepath=None, keep_original_name=False, **kwargs):
        """ Download all episodes from the season. See :func:`~jellyfinapi.base.Playable.download` for details.
...
class Episode(
    ...
    """ Represents a single Episode.
        ...
        Attributes:
            ...
            grandparentGuid (str): Jellyfin GUID for the show (jellyfin://show/5d9c086fe9d5a1001f4d9fe6).
            ...
            grandparentSlug (str): The clean watch.jellyfin.tv URL identifier for the show.
            ...
            parentGuid (str): Jellyfin GUID for the season (jellyfin://season/5d9c09e42df347001e3c2a72).
    ...
    def _loadData(self, data):
        ...
        # https://forums.jellyfin.tv/t/parentratingkey-not-in-episode-xml-when-seasons-are-hidden/300553
    ...
    @cached_property
    def _season(self):
        """ Returns the :class:`~jellyfinapi.video.Season` object by querying for the show's children. """
    ...
    def season(self):
        """" Return the episode's :class:`~jellyfinapi.video.Season`. """
        return self.fetchItem(self.parentKey)

    def show(self):
        """" Return the episode's :class:`~jellyfinapi.video.Show`. """
...
class Clip(
    ...
    """ Represents a single Clip.
        ...
        Attributes:
            ...
            index (int): Jellyfin index number for the clip.
            media (List<:class:`~jellyfinapi.media.Media`>): List of media objects.
...
@utils.registerJellyfinObject
class MovieSession(JellyfinSession, Movie):
...
@utils.registerJellyfinObject
class EpisodeSession(JellyfinSession, Episode):
...
@utils.registerJellyfinObject
class ClipSession(JellyfinSession, Clip):
...
@utils.registerJellyfinObject
class MovieHistory(JellyfinHistory, Movie):
    """ Represents a single Movie history entry
        loaded from :func:`~jellyfinapi.server.JellyfinServer.history`.
    """
    _HISTORYTYPE = True
    ...
    def _loadData(self, data):
        """ Load attribute values from Jellyfin XML response. """
        Movie._loadData(self, data)
        JellyfinHistory._loadData(self, data)


@utils.registerJellyfinObject
class EpisodeHistory(JellyfinHistory, Episode):
...
@utils.registerJellyfinObject
class ClipHistory(JellyfinHistory, Clip):
